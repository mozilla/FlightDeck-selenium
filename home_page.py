...
class HomePage(Page):
    ...
    def click_create_addon_link(self):
        self.selenium.find_element_by_xpath(self._create_addon_link).click()

    def check_addon_disable_btn_present(self):
        try:
            self.selenium.find_element_by_xpath(self._addon_disable)
            return True
    ...
    def check_lib_disable_btn_present(self):
        try:
            self.selenium.find_element_by_xpath(self._library_disable)
            return True
        except NoSuchElementException:
            return False
